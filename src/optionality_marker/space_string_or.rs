...
/// Deserializes an `Option<T>` treating an single space (`" "`) as `None` and otherwise attempting
/// to deserialize as `T`.
///
/// # Examples
///
...
/// struct Example {
///     #[serde(with = "serde_field_attributes::space_string_or")]
///     value: Option<String>,
/// }
///
...
/// Serializes an `Option<T>`, writing an space (`" "`) for `None` and delegating to `T`'s
...
mod tests {
    ...
    #[test]
    fn deserialize_space_string_as_none() {
        let json = r#"{"value":" "}"#;
    ...
    #[test]
    fn deserialize_non_space_string_as_some() {
    ...
    #[test]
    fn deserialize_space_string_as_outer_none() {
        let json = r#"{"value":" "}"#;
        let result: OptionalStringData = serde_json::from_str(json).unwrap();
    ...
    #[test]
    fn deserialize_space_string_as_none_for_integer_type() {
        let json = r#"{"value":" "}"#;
        let result: U64Data = serde_json::from_str(json).unwrap();
    ...
    #[test]
    fn deserialize_space_string_as_none_for_struct_type() {
        let json = r#"{"value":" "}"#;
        let result: StructData = serde_json::from_str(json).unwrap();
    ...
    #[test]
    fn serialize_none_as_space_string() {
    ...
    #[test]
    fn serialize_none_integer_as_space_string() {
