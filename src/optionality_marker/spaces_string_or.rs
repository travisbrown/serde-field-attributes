...
/// Deserializes an `Option<T>` treating a string composed entirely of spaces as `None` and
/// otherwise attempting to deserialize as `T`.
///
/// # Examples
///
/// ```
...
/// struct Example {
///     #[serde(with = "serde_field_attributes::spaces_string_or")]
///     value: Option<String>,
/// }
///
...
pub fn deserialize<'de, T: Deserialize<'de>, D: Deserializer<'de>>(
    ...
    let wrapper = super::StringCheckDeserializer {
        inner: deserializer,
        predicate: |input| input.bytes().all(|byte| byte == b' '),
        is_hit: &is_hit,
    };
